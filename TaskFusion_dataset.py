...
class Fusion_dataset(Dataset):
    def __init__(self, split='train', ir_path=None, vi_path=None):
        super(Fusion_dataset, self).__init__()
        assert split in ['train', 'val', 'test'], 'split must be "train"|"val"|"test"'

        if split == 'train':
            data_dir_vis = './MSRS/train/vi/'
            data_dir_ir = './MSRS/train/vi/'
            data_dir_label = './MSRS/train/Segmentation_labels'
